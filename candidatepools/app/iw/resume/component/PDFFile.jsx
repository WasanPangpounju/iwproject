...
const PDFFile = ({ type, dataUser, dataSkills, dataEducations, dataHistoryWork, yearToday }) => {
  return (
      ...
      <Page style={tw('flex flex-row p-0 text-sm')}>
        {type === 1 ? (
                ...
                <View style={tw('p-5')}>
                  ...
                  <View style={tw('flex flex-col gap-y-2')}>
                    ...
                    <View style={tw('flex flex-row gap-1 flex-wrap')}>
                      <Text>วันเกิด: {dataUser.dateBirthday || "-"} {dataUser.monthBirthday || "-"} {dataUser.yearBirthday || "-"}</Text>
                      <Text>({yearToday - dataUser.yearBirthday || "-"}ปี)</Text>
                    </View>
                    <View style={tw('flex flex-row gap-1 flex-wrap')}>
                      <Text>ความพิการ: </Text>
          ...
          <View style={tw(' flex flex-col overflow-hidden border w-full')}>
            {/* Top Section */}
            <View style={tw('bg-[#f48e07] text-white flex flex-row items-center gap-10')}>
          ...
          <View style={tw(' flex flex-col overflow-hidden border w-full')}>
            ...
            <View style={tw(' text-black flex flex-row items-center ')}>
              ...
              <View style={tw('flex flex-col gap-5')}>
                <Text style={[styles.fontNameThai, tw('font-bold ')]}>{dataUser.firstName} {dataUser.lastName}</Text>
                <Text style={[styles.fontNameEng, tw('font-bold capitalize text-gray-500')]}>{dataUser.firstNameEng} {dataUser.lastNameEng}</Text>
              </View>
            </View>
