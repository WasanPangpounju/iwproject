...
export async function POST(req) {
    try {
        ...
        await mongoDB();
        await Users.create({ uuid: id, user: user, password: hashedPassword, firstName: firstName, lastName: lastName, typeDisabled: typeDisabled, university: university, email: email, typePerson: typePerson });
