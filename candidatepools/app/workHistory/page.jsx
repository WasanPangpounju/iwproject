        ...
        <div className={`${bgColorMain} ${bgColor} ${fontSize}`}>
            ...
            <div className="flex">
                ...
                <div className="w-10/12 px-7 py-5">
                    ...
                    <form onSubmit={(e) => handleSubmit(e, projects.length, internships.length, works.length)} className={`${bgColorMain2} ${bgColor} ${fontSize} rounded-lg p-5 flex flex-col gap-16`}>
                        <div>
