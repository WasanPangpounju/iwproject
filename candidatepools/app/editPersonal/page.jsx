...
function EditPersonal() {
    ...
    const [errorIdCardDisabled, setErrorIdCardDisabled] = useState(false);
                    ...
                    <div className=" bg-white rounded-lg p-5 pb-10">
                            ...
                            <form onSubmit={handleEditSubmit} className="flex gap-x-10 gap-y-5 gap- flex-wrap">
                                ...
                                <div className="flex col flex-col">
                                    ...
                                    <input
                                        type="text"
                                        className={`placeholder-black focus:bg-white focus:cursor-text ${nickname ? "bg-gray-200 cursor-default focus:outline-none" : " "} border-gray-400 mt-1 w-56 border py-2 px-4 rounded-lg`}
                                ...
                                <div className=" flex flex-col">
                                    ...
                                    <div className="relative col w-fit mt-1">
                                        <select onChange={(e) => setNationality(e.target.value)} className='w-32 cursor-pointer border border-gray-400 py-2 px-4 rounded-lg' placeholder='กรอกชื่อผู้ใช้' style={{ appearance: 'none' }}>
                                ...
                                <div className=" flex flex-col">
                                    ...
                                    <div className="relative col w-fit mt-1">
                                        <select onChange={(e) => setReligion(e.target.value)} className='w-32 cursor-pointer border border-gray-400 py-2 px-4 rounded-lg' placeholder='กรอกชื่อผู้ใช้' style={{ appearance: 'none' }}>
                                ...
                                <div className="flex col flex-col">
                                    ...
                                    <input
                                        type="text"
                                        className={`placeholder-black focus:bg-white focus:cursor-text ${idCard ? "bg-gray-200 cursor-default focus:outline-none" : " "} border-gray-400 mt-1 w-64 border py-2 px-4 rounded-lg`}
                                ...
                                <div className="flex col flex-col">
                                    ...
                                    <input
                                        type="text"
                                        className={`placeholder-black focus:bg-white focus:cursor-text ${idCardDisabled ? "bg-gray-200 cursor-default focus:outline-none" : " "} border-gray-400 mt-1 w-64 border py-2 px-4 rounded-lg`}
                                ...
                                <div className="flex gap-x-10 flex-wrap w-full">
                                    <div className="flex col flex-col">
                                        ...
                                        <input
                                            type="text"
                                            className={`placeholder-black focus:bg-white focus:cursor-text ${address ? "bg-gray-200 cursor-default focus:outline-none" : " "} border-gray-400 mt-1 w-72 border py-2 px-4 rounded-lg`}
                                    ...
                                    <div className=" flex flex-col">
                                        ...
                                        <div className="relative col w-fit mt-1">
                                            <select
                                                ...
                                                className='w-36 cursor-pointer border border-gray-400 py-2 px-4 rounded-lg'
                                ...
                                <div className="flex col flex-col">
                                    ...
                                    <input
                                        type="tel"
                                        className={`placeholder-black focus:bg-white focus:cursor-text ${tel ? "bg-gray-200 cursor-default focus:outline-none" : " "} border-gray-400 mt-1 w-60 border py-2 px-4 rounded-lg`}
                                ...
                                <div className="flex col flex-col">
                                    ...
                                    <input
                                        type="tel"
                                        className={`placeholder-black focus:bg-white focus:cursor-text ${telEmergency ? "bg-gray-200 cursor-default focus:outline-none" : " "} border-gray-400 mt-1 w-60 border py-2 px-4 rounded-lg`}
                                ...
                                <div className="flex col flex-col">
                                    ...
                                    <input
                                        type="text"
                                        className={`placeholder-black focus:bg-white focus:cursor-text ${relationship ? "bg-gray-200 cursor-default focus:outline-none" : " "} border-gray-400 mt-1 w-60 border py-2 px-4 rounded-lg`}
                                ...
                                <div className="flex gap-x-10 flex-wrap">
                                    ...
                                    <div className="flex col flex-col ">
                                        ...
                                        <input
                                            type="text"
                                            className={`placeholder-black focus:bg-white focus:cursor-text ${detailDisabled ? "bg-gray-200 cursor-default focus:outline-none" : " "} border-gray-400 mt-1 w-60 border py-2 px-4 rounded-lg`}
