                ...
                <div className="w-10/12 px-7 py-5">
                    ...
                    <div className={`${bgColorMain2} pt-5 rounded-lg `}>
                        ...
                        <div className='mt-10 px-16'>
                            <p>
                                <span className={` ${inputTextColor === "text-white" ? "text-[#0c5c9b]" : ""}`}>โดยส่งเสริมนักศึกษาพิการที่ตั้งใจเรียน ต้องการพัฒนาตนเอง</span> ให้มีความมั่นใจ สามารถคิด
                                วิเคราะห์ แก้ปัญหา ตัดสินใจที่ดี และ <span className={` ${inputTextColor === "text-white" ? "text-[#0c5c9b]" : ""}`}>ได้ทำงานระหว่างเรียน (Work and Study) ที่ศูนย์ฯ DSS
                                    หรือหน่วยงานในมหาวิทยาลัย</span> เพื่อฝึกทักษะความรับผิดชอบ การจัดการเวลา การสื่อสาร
                                การประสานงาน และทำงานเป็นทีม โดยทำงานสัปดาห์ละ 15-20 ชั่วโมง ตลอด 12 เดือน มีรายได้จากองค์กรนายจ้าง (สัญญามาตรา 35-จ้างเหมาบริการ)
                            </p>
                        </div>
                        <div className='mt-10 flex gap-10 px-16'>
                            <div className='flex flex-col w-fit items-center gap-2'>
                                ...
                                <Image className={`w-36 h-auto flex-shrink-0`} src={`/image/hand.PNG`} height={1000} width={1000} priority alt="poster" />
                            </div>
                            <div className={`max-w-80 ${inputTextColor === "text-white" ? "text-[#0c5c9b]" : ""} `}>
                                <p className='text-lg font-bold'>นักศึกษาพิการ</p>
                                <div className='flex flex-col gap-2  mt-1'>
                                    <div className='flex gap-2 items-center '>
                                        <Icon className='flex-shrink-0' path={mdiCheckboxMarkedCircleOutline} size={.8} />
                                        <p>
                                            ตั้งเป้าหมายอาชีพรายบุคคล
                                    ...
                                    <div className='flex gap-2 items-center '>
                                        <Icon className='flex-shrink-0' path={mdiCheckboxMarkedCircleOutline} size={.8} />
                                        <p>
                                            อบรมพัฒนาทักษะเชิงปฏิบัติการ
                                            Soft/Hard/RUN Skills
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div className={`max-w-80 ${inputTextColor === "text-white" ? "text-[#fe7e16]" : ""} `}>
                                <p className='text-lg font-bold'>เจ้าหน้าที่</p>
                                <div className='flex flex-col gap-2  mt-1'>
                                    <div className='flex gap-2 items-center '>
                                        <Icon className='flex-shrink-0' path={mdiCheckboxMarkedCircleOutline} size={.8} />
                                        <p>
                                            สร้างชุมชนการเรียนรู้เจ้าหน้าที่
                                            มหาวิทยาลัย (Community of
                                            Practice-COP)
                                        </p>
                                    </div>
                                    <div className='flex gap-2 items-center '>
                                        <Icon className='flex-shrink-0' path={mdiCheckboxMarkedCircleOutline} size={.8} />
                                        <p>
                                            อบรมความรู้การเตรียมพร้อม
                                            คนพิการสู่การทำงาน
                                            และการให้ Feedback / Coaching  / Counseling
                                        </p>
                                    </div>
                        ...
                        <div className='mt-10 px-16'>
                            ...
                            <div className='grid grid-cols-2 gap-2 mt-3'>
                                <div className='flex items-center gap-2'>
                                    <div className={`w-3 h-3 rounded-full ${bgColorNavbar === "bg-[#F97201]" ? "bg-[#0c5c9c]" : ""}`}></div>
                        ...
                        <div className='mt-10'>
                            <Image className={`w-full h-auto flex-shrink-0`} src={`/image/list_university.PNG`} height={1000} width={1000} priority alt="poster" />
                        </div>
                    </div>
                </div>
            </div>
