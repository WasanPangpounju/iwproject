...
function NavbarLogo() {
    ...
    return (
        <div className={`relative gap-1 flex ${session ? "justify-between" : "justify-end"} border-b-8  border-[#75C7C2] `}>
            {dataUser && (
                <div className='flex items-center bg-[#eeeeee] py-4 px-5 w-60 gap-5'>
                    ...
                    <p className='text-lg font-extrabold'>{dataUser.firstName} {dataUser.lastName}</p>
                </div>
            )}
