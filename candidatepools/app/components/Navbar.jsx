...
function Navbar({ setFontSize, setBgColor,setBgColorNavbar,setBgColorWhite, fontSize,bgColorNavbar,bgColor,bgColorWhite   }) { // Accept setBgColor as a prop
...
// console.log('fontSize',fontSize);
    ...
    return (
        ...
        <div className={`${bgColorNavbar} px-5 py-2 flex items-center `}>
            ...
            <p className={`${bgColorWhite} font-thin  ms-2 ${fontSize}`}>ขนาดตัวอักษร</p>
            <div className='flex gap-2 ms-4'>
